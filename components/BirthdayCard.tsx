  ...
  return (
    <div 
      ...
      style={{ 
        ...
        fontVariant: 'normal' // Helps html2canvas font rendering
      }} 
    >
      ...
      {/* Grouping everything here ensures it stays above the background during capture */}
      <div className="relative z-10 w-full h-full flex flex-col justify-between p-8" style={{ color: '#FFFFFF' }}>
        
        {/* Top Text Section */}
        <div className="text-center pt-4">
          <p className="text-yellow-400 text-sm tracking-widest uppercase drop-shadow-md">{greeting}</p>
          <h1 className="text-5xl font-['Satisfy'] text-white my-2 drop-shadow-lg">{mainEvent}</h1>
        ...
        <div className="text-center space-y-2 pb-4">
          <p className="text-gray-200 text-sm font-light uppercase tracking-wide drop-shadow-md">{bestWishes}</p>
          <p className="font-bold text-lg tracking-wide uppercase drop-shadow-md">{recipientLine1}</p>
          <p className="text-gray-300 text-xs drop-shadow-md">{recipientLine2}</p>
          <p className="text-yellow-400 text-4xl font-['Satisfy'] py-1 drop-shadow-md">{cheers}</p>
          ...
          <p className="text-gray-400 text-[10px] tracking-widest uppercase mt-4 drop-shadow-md">{department}</p>
        </div>
